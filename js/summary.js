...
var summary2 = 'You started your day off going for a jog through the park and encountered a ' + color + ' ' + animal + '. ' + outcomeArray[0];

var summary3 = 'Next, you decided to head to your favorite café, but you ran into some crazy traffic trying to cross a busy intersection. You mulled over whether you wanted to wait for the light to change or if you should just make a run for it. ' + outcomeArray[1];

var summary4 = 'You finally made it to the café where ' + outcomeArray[2];

var summary5 = 'At the market you picked up some bread and ' + groceries + '. With your groceries in hand, you had one last decision to make, walk or take the bus. ' + outcomeArray[3];
